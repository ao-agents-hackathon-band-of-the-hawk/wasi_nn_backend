...
int test_lora_single_adapter() {
    ...
    if (file_exists("./test/LoRA_adapter1.gguf")) {
...
int test_lora_multi_adapter() {
    ...
    // Check adapter files
    bool adapters_exist = file_exists("./test/LoRA_adapter1.gguf") && file_exists("./test/LoRA_adapter2.gguf");
    if (adapters_exist) {
